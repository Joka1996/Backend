...
{
    [Service(Name = Litium.Accelerator.Constants.ProductTemplateNameConstants.ProductWithVariantList)]
    internal class ProductWithVariantListContentResolver : IProductTemplateResolver<IContentModel>
    {
        ...
        public ProductWithVariantListContentResolver(
        ...
        public Task<IContentModel> ResolveAsync(IResolveFieldContext context)
        {
            ...
            var viewModel = _productPageViewModelBuilder.Build(baseProduct);
            var model = viewModel.MapTo<ProductWithVariantListContentModel>();

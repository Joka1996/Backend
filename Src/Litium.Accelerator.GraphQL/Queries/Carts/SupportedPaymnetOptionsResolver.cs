...
{
    [Service]
    internal class SupportedPaymnetOptionsResolver : IFieldResolver<IEnumerable<OptionItemModel>>
    {
        ...
        public SupportedPaymnetOptionsResolver(
